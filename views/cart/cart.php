        ...
        <table class="table table-hover text-center">
          ...
          <?php foreach ($_SESSION['cart'] as $key => $value): ?>
            <tr>
              ...
              <td>
              <input type="number" name="updateproduct[<?=$value['id']; ?>][quantity]" class="form-control" value="<?=$value['productquantity']; ?>">
              </td>
          ...
          <tfoot>
            <tr>
              ...
              <td colspan="2"><button type="submit" name="updatecart" class="btn btn-primary mt-5 px-5">UPDATE</button></td>
